    ...
    class CompleteModalSystem {
        ...
        confirm(options = {}) {
            return new Promise((resolve) => {
                ...
                // ===== FIX: GESTIONE CORRETTA DEI TESTI BOTTONI =====
                const config = {
                    title: 'Conferma',
                    message: 'Sei sicuro?',
                ...
                // Se cancelText è null, significa che vogliamo solo il bottone di conferma
        ...
        alert(options = {}) {
            ...
            return this.confirm({
                ...
                cancelText: null  // Mostra solo il bottone OK
            });
        }
