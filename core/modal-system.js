// ===== MODAL SYSTEM DEFINITIVO - MODERN ES6 MODULE =====
'use strict';
    ...
    confirm(options = {}) {
        return new Promise((resolve) => {
            ...
            const config = {
                title: 'Conferma',
                message: 'Sei sicuro?',
                confirmText: options.confirmText !== undefined ? options.confirmText : 'Conferma',
                cancelText: options.cancelText !== undefined ? options.cancelText : 'Annulla',
                confirmClass: 'sol-btn-primary',
                type: 'confirm',
                ...options
            };
            
            const showCancelButton = config.cancelText !== null;
...
const modalSystem = new CompleteModalSystem();

// Assegna a 'window' per compatibilità con vecchi script che potrebbero usarlo
if (typeof window !== 'undefined') {
    window.ModalSystem = modalSystem;
    window.modalSystem = modalSystem;
}

// Esporta direttamente l'istanza. Questo è il modo standard e robusto.
