    ...
    function renderFullWidthForm() {
        return `
            <div class="fullwidth-form-wrapper">
                ...
                <!-- Import Tab - Layout CORRETTO -->
                <div class="tab-content" data-tab="import">
                    <div class="import-fullwidth">
                        <!-- Sezione superiore: Drop + Features laterali -->
                        <div class="import-top-section">
                            <!-- Drop Zone ridotta -->
                            <div class="optimized-drop-zone" id="enhDropZone">
                                <div class="drop-content-optimized">
                                    <div class="drop-visual">
                                        <div class="drop-icon">📁</div>
                                        <h2>Trascina qui i tuoi file</h2>
                                        <p>Oppure <button type="button" class="file-btn" onclick="document.getElementById('enhFileInput').click()">seleziona dal computer</button></p>
                            ...
                            <!-- Features laterali compatte -->
                            <div class="features-side-column">
                                <div class="feature-item-compact">
                                    <div class="feature-icon">🔍</div>
                                    <div class="feature-text">
                                        <strong>Auto-detection Formato</strong>
                                        <span>Rilevamento automatico formato e struttura</span>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item-compact">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <span>Associazione automatica colonne</span>
                                    </div>
                                </div>
                                ...
                                <div class="feature-item-compact">
                                    ...
                                    <div class="feature-text">
                                        ...
                                        <span>Anteprima completa prima import</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="features-title-separator">
                            📊 Funzionalità Import Avanzate
                        </div>
                        
                        <!-- Grid inferiore 2x2 -->
                        <div class="features-bottom-grid">
                            <div class="feature-item-compact">
                                <div class="feature-icon">⚡</div>
                                <div class="feature-text">
                                    <strong>Import Batch Veloce</strong>
                                    <span>Elaborazione rapida grandi quantità tracking</span>
                                </div>
                            </div>
                            ...
                            <div class="feature-item-compact">
                                ...
                                <div class="feature-text">
                                    ...
                                    <span>Report completo operazione import</span>
                                </div>
                            </div>
                            ...
                            <div class="feature-item-compact">
                                ...
                                <div class="feature-text">
                                    ...
                                    <span>Tracciabilità completa ogni operazione</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            /* Import section ottimizzata - NUOVO LAYOUT */
            .import-fullwidth {
                flex: 1;
                padding: 30px 30px 0 30px;
                height: calc(100% - 60px);
            ...
            .optimized-drop-zone:hover,
            .optimized-drop-zone.dragover {
                background: linear-gradient(135deg, #e6f3ff 0%, #cce7ff 100%);
                border-color: #0056b3;
                transform: scale(1.02);
            }
            
            .drop-content-optimized {
                text-align: center;
                padding: 40px 30px;
            }
            ...
            .drop-content-optimized h2 {
                margin: 0 0 8px 0;
                color: #333;
                font-size: 20px;
            }
            
            .drop-content-optimized p {
                margin: 0 0 16px 0;
                color: #6c757d;
                font-size: 14px;
            }
            ...
            /* Features container ottimizzato */
            .features-container-new {
                display: flex;
                flex-direction: column;
            }
            
            /* Prima colonna features a fianco del drop */
            .features-column-1 {
                background: white;
                border: 1px solid #e9ecef;
                border-radius: 8px;
            ...
            /* Grid per le features inferiori */
            .features-grid-new {
                display: grid;
