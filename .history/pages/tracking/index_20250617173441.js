...
// ========== COLUMN FORMATTERS FIXES - SEZIONE DA SOSTITUIRE IN index.js ==========
// Sostituisci la funzione getColumnFormatter con questa versione corretta:
...
function getColumnFormatter(key) {
    const formatters = {
        ...
        // MAPPING PER COLONNE SHIPSGO AIR
        origin_name: (value, row) => {
            // Per file ShipsGo Air, cerca nei metadata
            return value || 
