...
(function() {
    ...
    // 🔧 FIX LAYOUT TAB SINGOLO - Sostituisci solo la parte del tab singolo
    function renderSimplifiedForm() {
        return `
            <div class="ultra-compact-form">
                ...
                <!-- Single Tab - LAYOUT FISSATO -->
                <div class="tab-content active" data-tab="single">
                    <form id="enhancedSingleForm" class="fixed-form">
                        ...
                        <div class="main-grid">
                            ...
                            <div class="input-column">
                                ...
                                <div class="examples-row">
                                    <button type="button" class="example-btn" data-example="MSKU1234567">🚢</button>
                                    <button type="button" class="example-btn" data-example="176-12345678">✈️</button>
                                    <button type="button" class="example-btn" data-example="GESU1234567">📦</button>
                                </div>
                            </div>
                            ...
                            <div class="fields-column">
                                ...
                                <div class="fields-grid">
                                    <select id="enh_trackingType" class="field-input">
                                        <option value="auto">🔍 Auto</option>
                                        <option value="container">🚢 Container</option>
                                        <option value="awb">✈️ Air</option>
                                    </select>
                                    
                                    <select id="enh_carrier" class="field-input">
                                        <option value="">Vettore</option>
                                    </select>
                                    
                                    <input type="text" id="enh_origin" class="field-input" placeholder="Origine">
                                    <input type="text" id="enh_destination" class="field-input" placeholder="Destinazione">
                                    <input type="text" id="enh_reference" class="field-input" placeholder="Riferimento">
                                    
                                    <select id="enh_status" class="field-input">
                            ...
                            <div class="preview-column">
                                ...
                                <div class="preview-box">
                                    ...
                                    <div class="preview-item">
                                        <span id="previewType">Tipo</span>
                                    </div>
                                    <div class="preview-item">
                                        <span id="previewCarrier">Vettore</span>
                                    </div>
                                    <div class="preview-item">
                        ...
                        <div class="bottom-actions">
                            <button type="button" class="btn-action btn-cancel" onclick="window.ModalSystem.closeAll()">
                                <i class="fas fa-times"></i> Annulla
                            </button>
                            <button type="submit" class="btn-action btn-primary" id="enhSubmitBtn">
                ...
                <!-- Import Tab - MANTIENI QUELLO CHE FUNZIONA -->
            ...
            .api-toggle input:checked + .toggle-slider {
                background: #1a73e8;
            }
            
            .api-toggle input:checked + .toggle-slider:before {
            ...
            /* Import Styles - MANTIENI QUELLI CHE FUNZIONANO */
            .import-compact {
                height: 300px;
            }
