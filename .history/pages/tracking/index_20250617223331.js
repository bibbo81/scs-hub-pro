...
function showColumnManager() {
    ...
    const columnsToHide = ['pol_country', 'pol_country_code', 'pod_country', 'pod_country_code', 'port_of_loading', 'port_of_discharge', 'origin',              // Nascosto: usiamo origin_port unificato'origin_name',         // Nascosto: usiamo origin_port unificato
