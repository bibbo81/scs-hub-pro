...
export class TableManager {
    constructor(containerId, options = {}) {
        ...
        // 🔧 FIX: Inizializzazione AdvancedSearch sicura
        ...
        setTimeout(() => {
            if (window.AdvancedSearch) {
                ...
                console.warn('⚠️ AdvancedSearch non disponibile');
            }
        }, 100);
    ...
    // 🔧 FIX 2: SOSTITUISCI applyFilters() con AdvancedSearch
    applyFilters() {
        console.log('applyFilters called with searchTerm:', this.searchTerm);
        
        let filtered = [...this.data];
        
        // 🆕 NUOVA LOGICA: Usa AdvancedSearch invece della ricerca semplice
    ...
    // 🔧 FIX 3: SOSTITUISCI attachEventListeners() con debouncing e suggerimenti
    attachEventListeners() {
        // Search con debouncing
        const searchInput = this.container.querySelector('.sol-table-search-input');
        console.log('Search input found:', !!searchInput);
        if (searchInput) {
            // 🆕 NUOVO: Event listener con debouncing
            ...
            // 🆕 NUOVO: Gestione suggerimenti (opzionale)
    ...
    // 🆕 AGGIUNGI: Metodi per suggerimenti
    ...
    // AGGIUNGI QUESTO: Mini-refresh dei dati senza perdere stato
    setTimeout(() => {
        const currentData = [...this.displayData];
        this.displayData = [];
        this.displayData = currentData;
        
        // Aggiorna solo il contenuto della tabella
        const tbody = this.container.querySelector('tbody');
        if (tbody) {
            tbody.innerHTML = this.displayData.map((row, index) => 
    ...
    // AGGIUNGI QUESTO NUOVO METODO QUI:
