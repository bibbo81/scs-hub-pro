...
(function() {
    ...
    class CompleteModalSystem {
        ...
        confirm(options = {}) {
            return new Promise((resolve) => {
                ...
                const config = {
                    title: 'Conferma',
                    message: 'Sei sicuro?',
                    confirmText: 'Conferma',  // ← FIX
                    cancelText: 'Annulla',    // ← FIX
        ...
        alert(options = {}) {
            ...
            return this.confirm({
                ...
                cancelText: undefined  // ← FIX: undefined invece di null
            });
        }
    ...
    // Invece di export, rendi disponibile globalmente
    window.ModalSystem = window.ModalSystem || CompleteModalSystem;

    // Per compatibilità con i moduli
