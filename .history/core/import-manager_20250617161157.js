...
(function() {
    ...
    // ===== STATUS MAPPING BASATO SU GOOGLE SHEETS - MAPPING COMPLETO =====
    const STATUS_MAPPING = {
        // Maritime statuses
        'Sailing': 'in_transit',
        'Arrived': 'arrived',
        'Delivered': 'delivered',
        'Discharged': 'arrived',  // ===== CORRETTO: Discharged = Scaricato = arrived =====
        ...
        // Italian translations (mapped values from Google Sheets)
        'In transito': 'in_transit',
        'Arrivata': 'arrived',
        'Consegnato': 'delivered',
        'Scaricato': 'arrived',  // ===== CORRETTO: Scaricato = arrived =====
