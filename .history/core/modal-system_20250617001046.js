        ...
        confirm(options = {}) {
            return new Promise((resolve) => {
                ...
                const config = {
                    title: 'Conferma',
                    message: 'Sei sicuro?',
                    confirmText: 'Conferma',  // ← FIX: Testo corretto invece di null
                    cancelText: 'Annulla',    // ← FIX: Testo corretto invece di null
                    confirmClass: 'sol-btn-primary',
                    type: 'confirm',
                    ...options  // Le opzioni dell'utente sovrascrivono i default
                };
