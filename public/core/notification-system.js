// notification-system.js - Sistema notifiche toast unificato
(function() {
    'use strict';
    ...
    class NotificationSystem {
        ...
        show(message, type = 'info', duration = 3000, options = {}) {
            ...
            notification.innerHTML = `
                ...
                ` : ''}
                <button onclick="NotificationSystem.instance.dismiss('${id}')" style="
                    background: transparent;
                    border: none;
    ...
    // Export globale
    window.NotificationSystem = NotificationSystem.instance;
    window.showNotification = (message, type, duration, options) => {
        return NotificationSystem.instance.show(message, type, duration, options);
    };
})();