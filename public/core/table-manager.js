                ...
                <div class="sol-table-controls">
                    ...
                    <div class="sol-table-actions">
                        ${this.options.exportable ? `
                            <button class="sol-btn sol-btn-sm sol-btn-glass" onclick="tableManager.export('csv')">
                                <i class="fas fa-file-csv"></i> CSV
                            </button>
                            <button class="sol-btn sol-btn-sm sol-btn-glass" onclick="tableManager.export('excel')">
