// header-component.js - Header unificato per tutte le pagine
(function() {
    'use strict';
    ...
    class HeaderComponent {
        ...
        renderCustomActions() {
            return this.options.customActions.map(action => `
                <button class="sol-btn sol-btn-glass" onclick="${action.handler}">
        ...
        async loadNotifications() {
            try {
                const data = await window.api?.get('notifications', { silent: true });
